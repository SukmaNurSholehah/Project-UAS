...
public class anggota extends koneksi {
    ...
    public DefaultTableModel filterTable(String nama) {
     ...
     public void aturTable(JTable tData) {
        ...
        tData.getColumnModel().getColumn(3).setPreferredWidth(100); // Jenis Kelamin
        tData.getColumnModel().getColumn(4).setPreferredWidth(100); // Tanggal Lahir
        tData.getColumnModel().getColumn(5).setPreferredWidth(50); // Status
        tData.getColumnModel().getColumn(4).setPreferredWidth(100); // Tanggal Gabung
        tData.getColumnModel().getColumn(5).setPreferredWidth(50); // Sabuk
